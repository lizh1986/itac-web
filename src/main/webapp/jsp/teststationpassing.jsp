...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/teststationpassing.js"></script>
	</head>
	<body onresize="resize()>
		<div id="searchTable">
			<span style='margin-bottom:12px'>SN:</span>
			<textarea id="sns" style="height: 16px;resize:none" spellcheck="false"></textarea>
			<a href="#" class="easyui-linkbutton" plain="true" onclick="openDialog()">Batch</a>
			<a href="#" class="easyui-linkbutton" plain="true" onclick="execute()">Execute</a>
		</div>
		<div>
			<table id="resultTable"></table>
		</div>
		<div id="searchDialog" style="display:none; padding: 20px 20px 10px 20px;">
			<label id="searchLabel">Please input SNs:</label><br>
			<textarea id="searchText" style="width: 340px; height: 150px; margin-top: 10px; margin-bottom: 10px;" spellcheck="false"></textarea>
			<span style="margin-right: 15px; margin-top: 20px;">Tip: SNs are seperated by new line break.</span>
		</div>
	</body>
</html>