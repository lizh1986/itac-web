			...
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					if (buttonName == 'title') {
						...
						// 循环月份
						var monthDigit = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
						for(i=0;i<=11;i++){
							selectHtml +="<option value='"+i+"'>" + $.trim(monthDigit[i]) + "</option>";
						}
						selectHtml +="</select>";
						selectHtml +="</span>";
						/*********************************** End ***************************************/
